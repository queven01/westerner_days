...
$accordions = $accordion_content['accordion'];

$search_bar = $accordion_content['search_bar'];
        ...
        <section class="standard-page content-area">
            <?php if($search_bar):?>
                <div class="filter-bar">
                    <input type="text" id="myInput" onkeyup="_filterFunction()" placeholder="Search...">
                </div>
            <?php endif;?>
                ...
                <div class="accordion" id="accordionPage">
                    <?php $i = 0; foreach($accordions as $accordion):
                        ...
                        <div class="accordion-item">
                            <button class="accordion-button <?php if($i != 0){echo 'collapsed';}?>" type="button" data-bs-toggle="collapse" data-bs-target="#collapse<?php echo $i; ?>" aria-expanded="true" aria-controls="collapse<?php echo $i; ?>">
                                <h3 class="title"><?php echo $accordion['item_title']?></h3>
                            </button>
                            <div id="collapse<?php echo $i; ?>" class="accordion-collapse collapse <?php if($i == 0){echo 'show';}?>" aria-labelledby="heading<?php echo $i; ?>" data-bs-parent="#accordionPage">
                                                ...
                                                <div class="nested-column">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12 col-md-7 col-lg-9">
                                                            ...
                                                            <?php endif; ?>
                                                            <?php if($link_2):?>
                                                                <a class="btn blue" target="<?php echo $link_2['target'];?>" href="<?php echo $link_2['url'];?>"><?php echo $link_2['title'];?></a>
                                                            <?php endif; ?>
                                                        </div>
                                                    </div>
                                                </div>
